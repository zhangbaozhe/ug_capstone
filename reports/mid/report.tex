...
Our primary objective is to guide a quadrotor team 
to traverse both static and dynamic gates, starting 
from an initial position and culminating at a 
pre-determined goal position. The overarching goal 
is not just navigation, but to achieve this 
traversal in the least possible time, thus 
accentuating the efficiency of the process.
