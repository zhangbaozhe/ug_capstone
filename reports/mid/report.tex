...
State-lattice method is also used for kinodynamic motion 
planning. 
In \cite{zhou2019robust}, the authors use a state-lattice
method in the frontend to generate possible motion 
primitives and then 
