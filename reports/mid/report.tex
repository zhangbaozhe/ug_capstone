...
\author{
  \IEEEauthorblockN{
    ...
    Yuan Gao\textsuperscript{1,2}, 
    and Tin Lun Lam\textsuperscript{1,2}
  }
}
...
\renewcommand\thefootnote{\textsuperscript{2}}
\footnotetext{Shenzhen Institute of Artificial Intelligence
and Robotics for Society (AIRS), Shenzhen, China} 
\endgroup
...
re-planning, the local path-planning can be avoided.}  
...
variants (e.g., RRT* and PRM*) use sampling in the 
...
In traditional planning and control pipeline, the two modules
are separated, where the control module is responsible for 
trajectory tracking. 
